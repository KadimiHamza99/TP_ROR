...
class MaterielsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create materiel" do
    assert_difference('Materiel.count') do
      post materiels_url, params: { materiel: { marque: @materiel.marque, os: @materiel.os } }
    end
  ...
  test "should update materiel" do
    patch materiel_url(@materiel), params: { materiel: { marque: @materiel.marque, os: @materiel.os } }
