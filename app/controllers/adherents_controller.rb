class AdherentsController < ApplicationController
  ...
  def export
    myarray = Adherent.all
    CSV.open("C:\\Users\\LENOVO\\Desktop\\semestre8\\Ruby On Rails\\cours\\Test Ruby on Rails\\LibraryManagement\\public\\sortie.csv", "w") do |f|
           myarray.each do |x|
                f << [x]
              end
        end
  ...
  private
    ...
    def adherent_params
      params.require(:adherent).permit(:nom, :prenom, :status)
    end
end
